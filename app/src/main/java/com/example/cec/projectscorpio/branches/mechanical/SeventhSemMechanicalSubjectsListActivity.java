package com.example.cec.projectscorpio.branches.mechanical;
...
public class SeventhSemMechanicalSubjectsListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        subjectsView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(SeventhSemMechanicalSubjectsListActivity.this, YoutubeActivity.class);
